...
// API Configuration
export const ZHIPU_API_KEY = "622a20f0d8be4870905645442c14e8bd.bueRydYdlXRoxxTP";
export const ZHIPU_API_URL = "https://open.bigmodel.cn/api/paas/v4/chat/completions";

// specific model IDs requested
...
export const Icons = {
  ...
  SidebarLeft: (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
